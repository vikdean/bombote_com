...
username = 'username'
password = base64.b64decode(b'passsss')
...
def login_to_device():
    ...
    for device in devices:
        ...
        try:
            ...
            command = connection.send_command('show cdp neighbor detail | s Device|Management address')
...
def get_output_from_cdp_neighbors(input_string):
    ...
    filtered_lines3 = list(filter(lambda a: a != 'Management address(es): ', filtered_lines2))
    newlist = []
    for number in filtered_lines3:
...
# Writing to file
            ...
            print('\x1b[6;37;41m' + 'CDP neighbors already collected -> Skipping' + '\x1b[0m' + '\n')
            print('-' * 79 + '\n')
