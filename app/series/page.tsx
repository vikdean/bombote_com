          ...
          <div className="grid grid-cols-1 md:grid-cols-[230px_230px_1fr] gap-4 my-4">
            <Card className="shadow-2xl bg-muted-foreground/20 border hover:border-emerald-500 w-full">
              <CardHeader>
                ...
                <CardDescription className="text-2xl md:text-3xl font-bold text-emerald-400">{series.length}</CardDescription>
              </CardHeader>
            </Card>
                ...
                <div className="flex items-center space-x-4 rounded-md pt-6">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-xs md:text-sm text-gray-300">
                      Please keep in mind, the ratings on this page are strictly based on my own taste and preferences for TV series and mini-series.
                    </p>
                  </div>
                </div>
              </CardContent>
