...
const top_picks = [
  {
    ...
    description: "The Modern Mens perfume; perfect scent, with incredible performance at an OK price (get the Parfum or EDP version if the Elixir is too expensive for you).  Highly recommended.",
  },
  {
    brand: "Initio",
    name: "Paragon",
