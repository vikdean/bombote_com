...
import { Sparkles, Film, Tv, Droplets, CirclePlay, Star, BriefcaseBusiness } from "lucide-react";
      ...
      <div className="min-h-screen relative isolate">
        <div className="max-w-[1920px] mx-auto pt-12 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <h1 className="bg-gradient-to-r from-white via-slate-200 to-slate-500 bg-clip-text text-2xl tracking-tight text-transparent sm:text-4xl md:text-5xl lg:text-6xl font-semibold font-sans pt-8 pb-3">
            ...
            <div className="container mx-auto max-w-6xl px-2 sm:px-4">
                  ...
                  <CardContent className="relative pb-4 sm:pb-6 md:pb-8">
                    <CardDescription className="text-center text-xs sm:text-sm text-muted-foreground leading-relaxed px-2">
                      <div className="inline-flex items-center gap-1 sm:gap-2 rounded-full border border-foreground/10 bg-foreground/5 px-2 py-1 sm:px-4 sm:py-2">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-muted-foreground">250+ Fragrances tested</span>
                      </div>
                    </CardDescription>
                  </CardContent>
                  ...
                  <CardContent className="relative pb-4 sm:pb-6 md:pb-8">
                    <CardDescription className="text-center text-xs sm:text-sm text-muted-foreground leading-relaxed px-2">
                      <div className="inline-flex items-center gap-1 sm:gap-2 rounded-full border border-foreground/10 bg-foreground/5 px-2 py-1 sm:px-4 sm:py-2">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-muted-foreground">2500+ Movies rated</span>
                      </div>
                    </CardDescription>
                  </CardContent>
                  <CardFooter className="relative px-4 pb-4 sm:px-6 sm:pb-6 md:px-8 md:pb-8">
              ...
              {/* Divider */}
              <div className="relative mt-10 mb-10 px-2 sm:px-4">
                <div className="absolute inset-0 flex items-center" aria-hidden="true">
                  <div className="w-full h-[3px] bg-gradient-to-r from-transparent via-violet-300/70 to-transparent blur-[2px]" />
                </div>
                <div className="relative flex justify-center">
                  <span className="inline-flex items-center gap-3 rounded-full border border-violet-300/50 bg-violet-500/20 px-5 py-1.5 text-[0.65rem] uppercase tracking-[0.4em] text-violet-100 shadow-[0_0_35px_rgba(139,92,246,0.4)]">
                    <span className="h-2 w-2 rounded-full bg-violet-200 shadow-[0_0_15px_rgba(196,181,253,0.8)]" />
                  </span>
                </div>
              </div>
              <div>
                {/* Portfolio Card */}
                <Card className="group relative overflow-hidden border-0 bg-card/70 backdrop-blur-xl transition-all duration-500 hover:scale-[1.05] hover:shadow-2xl border-border/30 mb-12">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br from-violet-500 to-violet-700 opacity-20 transition-all duration-500 group-hover:opacity-30 shadow-violet-500/20 group-hover:shadow-2xl group-hover:shadow-opacity-30`}
                  />
                  <div className="absolute -top-1/2 -left-1/2 h-[200%] w-[200%] bg-gradient-radial from-white/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                  <CardHeader className="relative pb-4 pt-6 sm:pb-6 sm:pt-8">
                    <div className={`absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-violet-500 to-violet-700`} />
                    <div
                      className={`mx-auto mb-3 sm:mb-4 flex h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-violet-700 shadow-2xl shadow-foreground/20 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}
                    >
                      <div className="rounded-full p-3 sm:p-4 md:p-6 bg-gradient-to-br from-white/20 to-transparent backdrop-blur-sm">
                        <BriefcaseBusiness className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12" />
                      </div>
                    </div>
                    <CardTitle className="text-center text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight text-foreground pt-1">Projects Portfolio</CardTitle>
                  </CardHeader>
                  <CardFooter className="relative px-4 pb-4">
                    <Link href="/portfolio" className="w-full">
                      <Button
                        className="w-full h-10 sm:h-11 md:h-12 flex items-center gap-2 bg-gradient-to-r text-foreground font-bold text-sm sm:text-base md:text-lg transition-all duration-300 from-violet-500 to-violet-700 hover:from-violet-600 hover:to-violet-800 hover:text-white hover:shadow-lg hover:shadow-gray-900/50"
                        variant="outline"
                      >
                        Open
                        <span className="text-xs sm:text-sm opacity-80">→</span>
